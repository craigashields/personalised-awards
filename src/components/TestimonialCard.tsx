...
const TestimonalCard = (props: Iprops) => {
  return (
    <div className="overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
      <div className="relative p-6">
        <figure className="relative z-10">
          <blockquote className="p-6 lg:text-lg text-sm leading-relaxed">
            <p>{props.testimonal.testimonial}</p>
          </blockquote>
            ...
            <div className="flex items-center gap-4 pt-4 text-sm text-emerald-500">
              <div className="flex flex-col gap-1">
                ...
                <cite className="not-italic">
                  <a href="http://www.microsoft.com">{props.testimonal.from}</a>
                </cite>
              </div>
            </div>
          </figcaption>
