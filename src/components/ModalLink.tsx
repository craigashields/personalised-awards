...
const ModalLink: React.FC<Props> = ({ post }) => {
        ...
        ? ReactDOM.createPortal(
            ...
            >
              ...
              >
                ...
                {/*        <!-- Modal body --> */}
                <article className="prose max-w-none text-sm md:text-base pt-8 pb-8 text-primary-700 prose-a:text-secondary hover:prose-a:text-primary-900">
